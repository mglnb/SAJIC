...
FSS = { FRONT: 0, BACK: 1, DOUBLE: 2, SVGNS: "http://www.w3.org/2000/svg" }, FSS.Array = "function" == typeof Float32Array ? Float32Array : Array, FSS.Utils = { isNumber: function isNumber(t) {
  ...
  return t = Math.max(t, e), t = Math.min(t, i);
}, FSS.Vector3 = { create: function create(t, e, i) {
    var r = new FSS.Array(3);return this.set(r, t, e, i), r;
  }, clone: function clone(t) {
    var e = this.create();return this.copy(e, t), e;
  }, set: function set(t, e, i, r) {
    ...
    return t[0] += e[0], t[1] += e[1], t[2] += e[2], this;
  }, addVectors: function addVectors(t, e, i) {
    return t[0] = e[0] + i[0], t[1] = e[1] + i[1], t[2] = e[2] + i[2], this;
  }, addScalar: function addScalar(t, e) {
    return t[0] += e, t[1] += e, t[2] += e, this;
  }, subtract: function subtract(t, e) {
    return t[0] -= e[0], t[1] -= e[1], t[2] -= e[2], this;
  }, subtractVectors: function subtractVectors(t, e, i) {
    return t[0] = e[0] - i[0], t[1] = e[1] - i[1], t[2] = e[2] - i[2], this;
  }, subtractScalar: function subtractScalar(t, e) {
    return t[0] -= e, t[1] -= e, t[2] -= e, this;
  }, multiply: function multiply(t, e) {
    return t[0] *= e[0], t[1] *= e[1], t[2] *= e[2], this;
  }, multiplyVectors: function multiplyVectors(t, e, i) {
    return t[0] = e[0] * i[0], t[1] = e[1] * i[1], t[2] = e[2] * i[2], this;
  }, multiplyScalar: function multiplyScalar(t, e) {
    return t[0] *= e, t[1] *= e, t[2] *= e, this;
  }, divide: function divide(t, e) {
    return t[0] /= e[0], t[1] /= e[1], t[2] /= e[2], this;
  }, divideVectors: function divideVectors(t, e, i) {
    return t[0] = e[0] / i[0], t[1] = e[1] / i[1], t[2] = e[2] / i[2], this;
  }, divideScalar: function divideScalar(t, e) {
    return 0 !== e ? (t[0] /= e, t[1] /= e, t[2] /= e) : (t[0] = 0, t[1] = 0, t[2] = 0), this;
  }, cross: function cross(t, e) {
    var i = t[0],
        r = t[1],
        s = t[2];return t[0] = r * e[2] - s * e[1], t[1] = s * e[0] - i * e[2], t[2] = i * e[1] - r * e[0], this;
  }, crossVectors: function crossVectors(t, e, i) {
  ...
  }, limit: function limit(t, e, i) {
    var r = this.length(t);return null !== e && e > r ? this.setLength(t, e) : null !== i && r > i && this.setLength(t, i), this;
  }, dot: function dot(t, e) {
    return t[0] * e[0] + t[1] * e[1] + t[2] * e[2];
  }, normalise: function normalise(t) {
    return this.divideScalar(t, this.length(t));
  }, negate: function negate(t) {
    return this.multiplyScalar(t, -1);
  }, distanceSquared: function distanceSquared(t, e) {
    var i = t[0] - e[0],
        r = t[1] - e[1],
        s = t[2] - e[2];return i * i + r * r + s * s;
  }, distance: function distance(t, e) {
    return Math.sqrt(this.distanceSquared(t, e));
  }, lengthSquared: function lengthSquared(t) {
    return t[0] * t[0] + t[1] * t[1] + t[2] * t[2];
  }, length: function length(t) {
    return Math.sqrt(this.lengthSquared(t));
  }, setLength: function setLength(t, e) {
    var i = this.length(t);return 0 !== i && e !== i && this.multiplyScalar(t, e / i), this;
  } }, FSS.Vector4 = { create: function create(t, e, i) {
    var r = new FSS.Array(4);return this.set(r, t, e, i), r;
  }, set: function set(t, e, i, r, s) {
...
}, FSS.Color.prototype = { set: function set(t, e) {
    t = t.replace("#", "");var i = t.length / 3;return this.rgba[0] = parseInt(t.substring(0 * i, 1 * i), 16) / 255, this.rgba[1] = parseInt(t.substring(1 * i, 2 * i), 16) / 255, this.rgba[2] = parseInt(t.substring(2 * i, 3 * i), 16) / 255, this.rgba[3] = FSS.Utils.isNumber(e) ? e : this.rgba[3], this;
  }, hexify: function hexify(t) {
    var e = Math.ceil(255 * t).toString(16);return 1 === e.length && (e = "0" + e), e;
  }, format: function format() {
    var t = this.hexify(this.rgba[0]),
        e = this.hexify(this.rgba[1]),
        i = this.hexify(this.rgba[2]);return this.hex = "#" + t + e + i, this.hex;
  } }, FSS.Object = function () {
  this.position = FSS.Vector3.create();
}, FSS.Object.prototype = { setPosition: function setPosition(t, e, i) {
...
}, FSS.Vertex.prototype = { setPosition: function setPosition(t, e, i) {
    return FSS.Vector3.set(this.position, t, e, i), this;
...
}, FSS.Triangle.prototype = { computeCentroid: function computeCentroid() {
...
}, FSS.Geometry.prototype = { update: function update() {
    if (this.dirty) {
      var t, e;for (t = this.triangles.length - 1; t >= 0; t--) {
        e = this.triangles[t], e.computeCentroid(), e.computeNormal();
      }this.dirty = !1;
    }return this;
  } }, FSS.Plane = function (t, e, i, r) {
  FSS.Geometry.call(this), this.width = t || 100, this.height = e || 100, this.segments = i || 4, this.slices = r || 4, this.segmentWidth = this.width / this.segments, this.sliceHeight = this.height / this.slices;var s,
      n,
      o,
      h,
      a,
  ...
  var i, r, s, n, o;if (this.geometry.update(), e) for (i = this.geometry.triangles.length - 1; i >= 0; i--) {
...
}, FSS.Scene.prototype = { add: function add(t) {
...
}, FSS.Renderer.prototype = { setSize: function setSize(t, e) {
  ...
  FSS.Renderer.prototype.render.call(this, t);var e, i, r, s, n;for (this.clear(), this.context.lineJoin = "round", this.context.lineWidth = 1, e = t.meshes.length - 1; e >= 0; e--) {
    if (i = t.meshes[e], i.visible) for (i.update(t.lights, !0), r = i.geometry.triangles.length - 1; r >= 0; r--) {
  ...
  FSS.Renderer.call(this), this.element = document.createElement("canvas"), this.element.style.display = "block", this.vertices = null, this.lights = null;var t = { preserveDrawingBuffer: !1, premultipliedAlpha: !0, antialias: !0, stencil: !0, alpha: !0 };return this.gl = this.getContext(this.element, t), this.unsupported = !this.gl, this.unsupported ? "WebGL is not supported by your browser." : (this.gl.clearColor(0, 0, 0, 0), this.gl.enable(this.gl.DEPTH_TEST), this.setSize(this.element.width, this.element.height), void 0);
  ...
  if (FSS.Renderer.prototype.render.call(this, t), !this.unsupported) {
    var e,
        ...
        d = !1,
        p = t.lights.length,
        F = 0;if (this.clear(), this.lights !== p) {
      if (this.lights = p, !(this.lights > 0)) return;this.buildProgram(p);
    }if (this.program) {
      for (e = t.meshes.length - 1; e >= 0; e--) {
        ...
        this.vertices = F;for (a in this.program.attributes) {
          for (u = this.program.attributes[a], u.data = new FSS.Array(F * u.size), f = 0, e = t.meshes.length - 1; e >= 0; e--) {
            for (i = t.meshes[e], r = 0, s = i.geometry.triangles.length; s > r; r++) {
              for (n = i.geometry.triangles[r], m = 0, g = n.vertices.length; g > m; m++) {
                switch (vertex = n.vertices[m], a) {case "side":
                    this.setBufferData(f, u, i.side);break;case "position":
                    this.setBufferData(f, u, vertex.position);break;case "centroid":
                    this.setBufferData(f, u, n.centroid);break;case "normal":
                    this.setBufferData(f, u, n.normal);break;case "ambient":
                    this.setBufferData(f, u, i.material.ambient.rgba);break;case "diffuse":
                    this.setBufferData(f, u, i.material.diffuse.rgba);}f++;
              }
            }
        ...
        switch (u = this.program.uniforms[l], S = u.location, c = u.data, u.structure) {case "3f":
            this.gl.uniform3f(S, c[0], c[1], c[2]);break;case "3fv":
            this.gl.uniform3fv(S, c);break;case "4fv":
  ...
  if (FSS.Utils.isNumber(i)) e.data[t * e.size] = i;else for (var r = i.length - 1; r >= 0; r--) {
  ...
  if (!this.unsupported) {
    var e = FSS.WebGLRenderer.VS(t),
        ...
        r = e + i;if (!this.program || this.program.code !== r) {
      var s = this.gl.createProgram(),
          n = this.buildShader(this.gl.VERTEX_SHADER, e),
          o = this.buildShader(this.gl.FRAGMENT_SHADER, i);if (this.gl.attachShader(s, n), this.gl.attachShader(s, o), this.gl.linkProgram(s), !this.gl.getProgramParameter(s, this.gl.LINK_STATUS)) {
  ...
  if (!this.unsupported) {
    var i = this.gl.createShader(t);return this.gl.shaderSource(i, e), this.gl.compileShader(i), this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS) ? i : (console.error(this.gl.getShaderInfoLog(i)), null);
  }
}, FSS.WebGLRenderer.prototype.buildBuffer = function (t, e, i, r, s, n) {
  var o = { buffer: this.gl.createBuffer(), size: r, structure: s, data: null };switch (e) {case "attribute":
      o.location = this.gl.getAttribLocation(t, i);break;case "uniform":
      o.location = this.gl.getUniformLocation(t, i);}return n && (o.data = new FSS.Array(n * r)), o;
  ...
  FSS.Renderer.prototype.clear.call(this);for (var t = this.element.childNodes.length - 1; t >= 0; t--) {
    this.element.removeChild(this.element.childNodes[t]);
  }return this;
}, FSS.SVGRenderer.prototype.render = function (t) {
  FSS.Renderer.prototype.render.call(this, t);var e, i, r, s, n, o;for (e = t.meshes.length - 1; e >= 0; e--) {
    if (i = t.meshes[e], i.visible) for (i.update(t.lights, !0), r = i.geometry.triangles.length - 1; r >= 0; r--) {
  ...
  var e = "fill:" + t + ";";return e += "stroke:" + t + ";";
};
...
var Home = function () {
    ...
    _createClass(Home, [{
        ...
        value: function bindEvents() {
            ...
            this.$closes.forEach(function (value, index) {
            ...
            this.$map.forEach(function (value, index) {
                ...
                if (value.id) {
                    var elem = {};
                    _this.$modals.forEach(function (value, index) {
                        if (value.getAttribute('data-id') == self.id) {
                            elem = _this.$modals[index];
                        }
                    });
                    value.addEventListener('click', function () {
                        try {
